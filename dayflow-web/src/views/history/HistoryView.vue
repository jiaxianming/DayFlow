...
/**
 * 历史报告列表：分页 + 状态 tag + 跳详情 + 删除 + 生成报告（对话框选今日/指定日期）
 */
...
<template>
  <div>
    ...
    <!-- 生成日报对话框：先选范围（今日 / 指定日期）再确认，避免一进来就误触生成 -->
    <el-dialog v-model="dialogVisible" title="生成日报" width="420px">
